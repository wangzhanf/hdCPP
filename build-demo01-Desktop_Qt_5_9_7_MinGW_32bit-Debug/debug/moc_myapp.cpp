...
QT_MOC_LITERAL(1, 6, 12), // "previousPage"
QT_MOC_LITERAL(2, 19, 0) // ""

    },
    "MyApp\0previousPage\0"
};
...
void MyApp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->previousPage(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (MyApp::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyApp::previousPage)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject MyApp::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_MyApp.data,
      qt_meta_data_MyApp,  qt_static_metacall, nullptr, nullptr}
};
